...
class VideoProcessingError(ZKStegoError):
    """Error during video processing (parsing, extraction, reconstruction)"""
    pass


class CAVLCError(ZKStegoError):
    """Error during CAVLC encoding/decoding"""
    pass
...
class ExtractionError(ZKStegoError):
    """Error during payload extraction"""
    pass
...
class InvalidVideoFormatError(VideoProcessingError):
    """Video format is not supported or malformed"""
    pass


class ValidationError(ZKStegoError):
